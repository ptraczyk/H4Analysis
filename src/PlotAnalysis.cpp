...
void PlotAnalysis::Init(LoopAndFill *l1)
{
	...
	for(unsigned int i=0;i<E.size() ;++i)
	   for( unsigned int iCh=0;iCh<unsigned(nChannels);++iCh)
		...
		l->BookHisto(Form("th2d_chint_sub_ch%d_E%d",iCh,E[i])," ch_int_sub vs HV",5000,0-50.,500000-50.,40,0.-20,2000-20,"TH2D");
		l->BookHisto(Form("th2d_maxampl_sub_ch%d_E%d",iCh,E[i])," max_ampl_sub vs HV",4000,-0.5,3999.5,40,0.-20.,2000-20,"TH2D");
		}
